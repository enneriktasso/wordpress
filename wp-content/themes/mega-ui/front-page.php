...
$mega_ui_banner_args= array('post_type' =>'post','post__not_in' => get_option( 'sticky_posts' ), 'post__in' => array($mega_ui_banner_post));
...
<div class="mega-ui-services update">
	<div class="container">
		...
		<div class="col-md-12 mega-ui-heading text-center">
			<h1 class="w600"><?php echo esc_html($mega_ui_service_title); ?></h1>
		</div>
	<?php } 
...
if($mega_ui_services->have_posts()){ ?>
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 mt5 mega-service">
...
<div id="content" class="blog-ui-section">
	...
	if($mega_ui_blog->have_posts()){ ?>
			<div class="col-md-12 col-sm-12">
				<div class="row">
					<?php if($mega_ui_blog_title!=''){ ?>
						<div class="col-md-12 mega-ui-heading text-center mt5">
						<h1 class="w600"><?php echo esc_html($mega_ui_blog_title); ?></h1>
					</div>
					<?php } while($mega_ui_blog->have_posts()){
						$mega_ui_blog->the_post();
						if(has_post_thumbnail()){ ?>
							<div class="col-md-4 col-sm-6 col-xs-12 mt5 blog4-box image-blog">
							<div class="card text-left">
								...
								<div class="card-bottom">
									<div class="comment w600"><span><i class="fa fa-comment"></i><br/><?php echo esc_html(get_comments_number()); ?></span></div>
						...
						<?php }else{ ?>
						<div class="col-md-4 col-sm-6 col-xs-12 mt5 blog4-box">
							<div class="card text-left">
								<div class="card-body">
									<h4 class="card-title"><a class="blue2" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>	
			...
			<div class="col-md-12">
				<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-10 offset-sm-1 mt5"> 
				<div class="mybutton5">
					<a href="<?php echo esc_url($mega_ui_posts_page); ?>" class="btn w700 lh130 text-center white"><?php esc_html_e('View More Posts','mega-ui'); ?></a>
				</div>
			</div>
		</div>
	<?php } } wp_reset_postdata(); ?>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-8 white">
                <h3 class="w300 lh140"><?php echo esc_html( get_the_title( $mega_ui_cta_page )); ?></h3>                   
            </div>
			
			<div class="col-md-4 text-center">              
                <a class="btn btn-default" href="<?php echo esc_url(get_the_permalink($mega_ui_cta_page)); ?>" role="button"><?php echo esc_html( $mega_ui_cta_btn ); ?></a>
            </div>
		</div>
	</div>
</div>
