...
{ global $comment_data;
	...
	<div id="comment-<?php echo esc_html($comment->comment_ID); ?>" class="row comment-body">						
		...
		<div class="col-lg-10 col-md-9 col-xs-9 lmt0 xsmt5">
			<h3 class="w600"><?php if($comment->comment_author_url!='') { ?><a href="<?php echo esc_url($comment->comment_author_url); ?>" rel="nofollow"><?php } comment_author(); if($comment->comment_author_url!='') echo '</a>'; ?> </h3>
			...
			<div class="mt2"><?php comment_text(); ?>
