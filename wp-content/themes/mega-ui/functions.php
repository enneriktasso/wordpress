...
function mega_ui_widgets_init() {
	register_sidebar( array(
		...
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widget-title p-2 ls2">',
		'after_title'   => '</h4>',
	) );
	
	register_sidebar( array(
		'name'          => __( 'WooCommerce Sidebar', 'mega-ui' ),
		'id'            => 'mega_ui_woo',
		'description'   => __( 'Sidebar for WooCommerce Pages', 'mega-ui' ),
		'before_widget' => '<div id="%1$s" class="col-12 p-2 mb-3 widget-box %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4 class="widget-title p-2 ls2">',
		'after_title'   => '</h4>',
	...
	register_sidebar( array(
		...
		'after_widget' => "</div>",
		'before_title' => '<h4 class="w700 blue2">',
		'after_title' => '</h4>',
	) );
	register_sidebar( array(
...
function mega_ui_scripts() {
	...
	wp_enqueue_style( 'mega-ui-google-font', 'https://fonts.googleapis.com/css?family=Nanum+Gothic' );
...
add_action('tgmpa_register', 'mega_ui_required_plugins');

function mega_ui_required_plugins() {
       /*
    ...
    $plugins = array(
        ...
        array('name' => esc_html__('Schema','mega-ui'),
             // The plugin name.
            'slug' => 'schema',
        ), 

        // This is an example of how to include a plugin from a private repo in your theme.
        array('name' => esc_html__('Color Your Bar','mega-ui'),
             // The plugin name.
            'slug' => 'color-your-bar',
        ),
    );
     ...
     */
    $config = array(
        'id'           => 'mega-ui',                 // Unique ID for hashing notices for multiple instances of TGMPA.
