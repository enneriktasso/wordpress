...
<div class="banner">
	<div class="container">
		<div class="col-12 text-center white">
			<?php the_archive_title( '<h1 class="w600 lh130 ls2 text-center white upper">', '</h1>' ); ?>
...
<div id="content" class="blog-ui-section">
	<div class="container">
		<div class="row">
			<div class="col-md-12 gray w400 ls2 template-property-name upper text-right"><?php if (function_exists('mega_ui_breadcrumbs')){ mega_ui_breadcrumbs(); } ?></div>
