...
<div class="banner">
	<div class="container">
		<div class="col-12 text-center white">
			<?php the_archive_title( '<h3 class="lh130 ls2 text-center white upper">', '</h3>' ); ?>
			 <?php if(get_the_author_meta('description')) : echo '<p>'.esc_html(get_the_author_meta('description')).'</p>'; ?>
       <?php endif; ?>
