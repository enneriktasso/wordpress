...
<?php _e( 'Skip to content', 'mega-ui' ); ?></a>
<?php if($mega_ui_topbar_switch==1){ ?>
<div class="top">
	<div class="container">
		<div class="row p-sm-0">
			<div class="col-md-6 col-sm-6 col-xs-12 p-sm-0 top-cont">
				<ul class="w500 mt2">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 p-sm-0 top-social">
	...
	<div class="container">
        ...
        <div class="col-lg-4 col-12 p-sm-0 float-left">
        	<div class="col-9 p-sm-0 float-left ">
				...
				<a class="navbar-brand align-middle" href="<?php echo esc_url(home_url( '/' )); ?>" title="<?php echo esc_html( get_bloginfo( 'name', 'display' ) ); ?>"><?php if(isset($mega_ui_logo)){ ?>
